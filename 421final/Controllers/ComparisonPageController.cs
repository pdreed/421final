...
namespace _421final.Views
{
    public class ComparisonPageController : Controller
    {
        ...
        public IActionResult Index(string textBoxValue)
        {
            ...
            else //text box had nothing entered
            {
                ComparisonPage vm2 = new ComparisonPage();
                vm2.searchErrorMsg = "Input required to perform a search.";
                PlayerRoot Nobody = new PlayerRoot();
                Nobody.Id = 1000000;
                Nobody.FirstName = "N/A";
                Nobody.LastName = "N/A";
                ...
                List<PlayerRoot> tempList = new List<PlayerRoot>();
                tempList.Add(Nobody);
                vm2.playerList1 = tempList;
                vm2.playerList2 = tempList;
                SeasonAvgRoot tempAvg = new SeasonAvgRoot();
                tempAvg.Ast = 0;
                tempAvg.Blk = 0;
                tempAvg.Pts = 0;
                ...
                vm2.fg3pct2 = 0;
                vm2.ftpct2 = 0;
                vm2.player1Stats = tempAvg;
                vm2.player2Stats = tempAvg;
                return View(vm2);
            }
